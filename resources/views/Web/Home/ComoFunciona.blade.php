    ...
    <div class="bg-white shadow-sm mt-3 rounded p-3">
        ...
        <div class="row bg-light py-5">
            ...
            <div class="col-md-8 border-left px-5 pt-md-2 order-2">
                ...
                <ul class="list-unstyled">
                    ...
                    <ul>
                        <li>1.	Accede al sitio http://negocios.com.gt/registro</li>
                        <li>2.	En la casilla que se indica ingresa tus Nombres </li>
                        <li>3.	En la casilla que se indica ingresa tus Apellidos</li>
                        <li>4.	Ingresa el CUI, el cual se verificara si es correcto de acuerdo al Registro Nacional de las Personas</li>
                        <li>5.	Ingresa una dirección de correo electrónico en el cual se te enviara la notificación correspondiente del registro</li>
                        <li>6.	Ingresa tu numero de teléfono</li>
                        <li>7.	Ingresa una contraseña, la cual te servirá para iniciar sesión al sitio NegoicosGT</li>
                        <li>8.	Confirma la contraseña ingresada con anterioridad</li>
                        <li>9.	Acepta los términos y condiciones, en la cual se regula la relación con los usuarios del sitio NegociosGT, de acuerdo al contenido y los servicios que se presta</li>
                        <li>10.	Dale Click al botón registro</li>
                        <li>11.	Posteriormente se te enviara a tu correo electrónico la confirmación de tu registro y ya podrás iniciar sesión y utilizar todas las funcionalidades del sitio</li>
                    </ul>
                </ul>
            </div>
        </div>
        ...
        <div class="row bg-light py-5">
            ...
            <div class="col-md-8 border-left px-5 order-2">
                ...
                <p>En esta sección cualquier persona que este buscando un determinado negocio o servicio lo podrá encontrar, de acuerdo a la información que se ha ingresado previamente.Las búsquedas podrán ser por tipo de negocio, si éste está ubicado en algún Departamento, Municipio, Aldea, Cantón, Sector en particular. Muchas personas están buscando los productos o servicios que tu haces, así que ingresa tu negocio para que mas personas puedan ubicarte.</p>
            </div>
        </div>
    </div>
