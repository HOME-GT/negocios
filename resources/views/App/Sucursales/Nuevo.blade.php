    ...
    <div class="mt-3 p-4 bg-white shadow-sm rounded">
        ...
        <div class="row border-bottom">
            <div class="col-md-8 text-center text-md-left text-lg-left">
                <h1 class="text-title">Nueva sucursal: {{$neg->neg_nombre_completo}}  </h1>
                <p>Crear nueva sucursal</p>
            </div>
            <div class="col-md-4 text-center text-md-right text-lg-right mb-4 mb-md-0 mb-lg-0">
                <a href="" class="btn btn-primary rounded-0"> <i class="fa fa-plus"></i> Nuevo </a>
            </div>
        </div>


        <div class="mt-2">
            <form action="{{route('app.sucursales.nuevo.post',$neg->neg_id)}}" method="POST"  enctype="multipart/form-data">
                @csrf
                    {{-- Información general --}}
                        ...
                        <div class="collapse show" data-parent="#infogeneral" id="infogeneralOne">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" id="negocio" name="negocio" class="invisible" value="{{ $neg->neg_id }}">
