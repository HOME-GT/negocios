...
@section('Main')
    ...
    <form action="{{route('app.negocio.edicion.post',$neg->neg_id)}}" method="POST" enctype="multipart/form-data">
        @csrf
            {{-- Información general --}}
                ...
                <div class="collapse show" data-parent="#infogeneral" id="infogeneralOne">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="nombre_completo" name="nombre_completo" class="form-control {{ $errors->has('nombre_completo') ? 'is-invalid' : '' }}" value="{{ old('nombre_completo',$neg->neg_nombre_completo) }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="nombre_corto" name="nombre_corto" class="form-control {{ $errors->has('nombre_corto') ? 'is-invalid' : '' }}" value="{{ old('nombre_corto',$neg->neg_nombre_corto) }}">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" id="descripcion" name="descripcion" class="form-control {{ $errors->has('descripcion') ? 'is-invalid' : '' }}" value="{{ old('descripcion',$neg->neg_descripcion) }}">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            @php
                                $item = (old("departamento",$neg->municipio->departamento->dep_id) != null ? \App\Models\departamento::where("dep_id", old("departamento",$neg->municipio->departamento->dep_id))->first() : null);
                            @endphp
                        ...
                        <div class="form-group col-md-4">
                            ...
                            @php
                                $item = (old("municipio",$neg->neg_mun_fk) != null ? \App\Models\municipio::where("mun_id", old("municipio",$neg->neg_mun_fk))->first() : null);
                            @endphp
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="ubicacion" name="ubicacion" class="form-control {{ $errors->has('ubicacion') ? 'is-invalid' : '' }}" value="{{ old('ubicacion',$neg->neg_ubicacion) }}" >
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            @php
                                $item = (old("categoria",$neg->neg_cat_fk) != null ? \App\Models\categoria::where("cat_id", old("categoria",$neg->neg_cat_fk))->first() : null);
                            @endphp
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" id="servicio_domicilio" name="servicio_domicilio"  class="custom-control-input" {{(old("servicio_domicilio",$neg->neg_servicio_dominicio) != null ? "checked":"")}}>
                    ...
                    <div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text"  id="telefono1" name="telefono1" class="form-control form-control-sm {{ $errors->has('telefono1') ? 'is-invalid' : '' }}" value="{{ old('telefono1',$neg->contacto->con_telefono1) }}" >
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" id="telefono2" name="telefono2" class="form-control form-control-sm {{ $errors->has('telefono2') ? 'is-invalid' : '' }}" value="{{ old('telefono2',$neg->contacto->con_telefono2) }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="correo1" name="correo1" class="form-control form-control-sm {{ $errors->has('correo1') ? 'is-invalid' : '' }}"  value="{{ old('correo1',$neg->contacto->con_correo1) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="correo2" name="correo2" class="form-control form-control-sm {{ $errors->has('correo2') ? 'is-invalid' : '' }}"  value="{{ old('correo2',$neg->contacto->con_correo2) }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="pagina" name="pagina" class="form-control form-control-sm {{ $errors->has('pagina') ? 'is-invalid' : '' }}" value="{{ old('pagina',$neg->contacto->con_pagina) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="facebook" name="facebook" class="form-control form-control-sm {{ $errors->has('facebook') ? 'is-invalid' : '' }}" value="{{ old('facebook',$neg->contacto->con_facebook) }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="google_maps" name="google_maps" class="form-control form-control-sm  {{ $errors->has('google_maps') ? 'is-invalid' : '' }}" value="{{ old('google_maps',$neg->contacto->con_google_maps) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" id="whatsapp" name="whatsapp" class="form-control form-control-sm  {{ $errors->has('whatsapp') ? 'is-invalid' : '' }}"  value="{{ old('whatsapp',$neg->contacto->con_whatsapp) }}" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="direccion" name="direccion" class="form-control form-control-sm {{ $errors->has('direccion') ? 'is-invalid' : '' }}"  value="{{ old('direccion',$neg->contacto->con_direccion) }}">
                    ...
                    <table class="table table-sm table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="inicio_lunes" name="inicio_lunes" class="timepicker form-control form-control-sm {{ $errors->has('inicio_lunes') ? 'is-invalid' : '' }}"  value="{{ old('inicio_lunes', Util::HOR_MIN_SEG_VIEW($neg->horario->hor_ini_lun)) }}" >
                                    @if ($errors->has('inicio_lunes'))
                                        <span class="invalid-feedback" role="alert"> {{ $errors->first('inicio_lunes') }} </span>
                                    @endif
                                </td>
                                <td>
                                    <input type="text"  id="fin_lunes" name="fin_lunes" class="timepicker form-control form-control-sm {{ $errors->has('fin_lunes') ? 'is-invalid' : '' }}"  value="{{ old('fin_lunes',Util::HOR_MIN_SEG_VIEW($neg->horario->hor_fin_lun)) }}">
                                ...
                                <td class="text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="cerrado_lunes" name="cerrado_lunes" {{(old("cerrado_lunes",$neg->horario->hor_cer_lun) != null)?"checked":""}}>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="inicio_martes" name="inicio_martes" class="timepicker form-control form-control-sm {{ $errors->has('inicio_martes') ? 'is-invalid' : '' }}"  value="{{ old('inicio_martes',Util::HOR_MIN_SEG_VIEW($neg->horario->hor_ini_mar)) }}">
                                    @if ($errors->has('inicio_martes'))
                                        <span class="invalid-feedback" role="alert"> {{ $errors->first('inicio_martes') }} </span>
                                    @endif
                                </td>
                                <td>
                                    <input type="text" id="fin_martes" name="fin_martes" class="timepicker form-control form-control-sm {{ $errors->has('fin_martes') ? 'is-invalid' : '' }}"  value="{{ old('fin_martes',Util::HOR_MIN_SEG_VIEW($neg->horario->hor_fin_mar)) }}">
                                ...
                                <td class="text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="cerrado_martes" name="cerrado_martes" {{(old("cerrado_martes",$neg->horario->hor_cer_mar) != null)?"checked":""}}>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="inicio_miercoles" name="inicio_miercoles"  class="timepicker form-control form-control-sm {{ $errors->has('inicio_miercoles') ? 'is-invalid' : '' }}"  value="{{ old('inicio_miercoles',Util::HOR_MIN_SEG_VIEW($neg->horario->hor_ini_mie)) }}">
                                    @if ($errors->has('inicio_miercoles'))
                                        <span class="invalid-feedback" role="alert"> {{ $errors->first('inicio_miercoles') }} </span>
                                    @endif
                                </td>
                                <td>
                                    <input type="text" id="fin_miercoles" name="fin_miercoles" class="timepicker form-control form-control-sm {{ $errors->has('fin_miercoles') ? 'is-invalid' : '' }}"  value="{{ old('fin_miercoles',Util::HOR_MIN_SEG_VIEW($neg->horario->hor_fin_mie)) }}">
                                ...
                                <td class="text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="cerrado_miercoles" name="cerrado_miercoles" {{(old("cerrado_miercoles",$neg->horario->hor_cer_mie) != null)?"checked":""}}>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="inicio_jueves" name="inicio_jueves"  class="timepicker form-control form-control-sm {{ $errors->has('inicio_jueves') ? 'is-invalid' : '' }}"  value="{{ old('inicio_jueves',Util::HOR_MIN_SEG_VIEW($neg->horario->hor_ini_jue)) }}">
                                    @if ($errors->has('inicio_jueves'))
                                        <span class="invalid-feedback" role="alert"> {{ $errors->first('inicio_jueves') }} </span>
                                    @endif
                                </td>
                                <td>
                                    <input type="text" id="fin_jueves" name="fin_jueves"  class="timepicker form-control form-control-sm {{ $errors->has('fin_jueves') ? 'is-invalid' : '' }}"  value="{{ old('fin_jueves',Util::HOR_MIN_SEG_VIEW($neg->horario->hor_fin_jue)) }}">
                                ...
                                <td class="text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="cerrado_jueves" name="cerrado_jueves" {{(old("cerrado_jueves",$neg->horario->hor_cer_jue) != null)?"checked":""}}>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="inicio_viernes" name="inicio_viernes" class="timepicker form-control form-control-sm {{ $errors->has('inicio_viernes') ? 'is-invalid' : '' }}"  value="{{ old('inicio_viernes',Util::HOR_MIN_SEG_VIEW($neg->horario->hor_ini_vie)) }}">
                                    @if ($errors->has('inicio_viernes'))
                                        <span class="invalid-feedback" role="alert"> {{ $errors->first('inicio_viernes') }} </span>
                                    @endif
                                </td>
                                <td>
                                    <input type="text" id="fin_viernes" name="fin_viernes" class="timepicker form-control form-control-sm {{ $errors->has('fin_viernes') ? 'is-invalid' : '' }}"  value="{{ old('fin_viernes',Util::HOR_MIN_SEG_VIEW($neg->horario->hor_fin_vie)) }}" >
                                ...
                                <td class="text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="cerrado_viernes" name="cerrado_viernes" {{(old("cerrado_viernes",$neg->horario->hor_cer_vie) != null)?"checked":""}}>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="inicio_sabado" name="inicio_sabado"  class="timepicker form-control form-control-sm {{ $errors->has('inicio_sabado') ? 'is-invalid' : '' }}"  value="{{ old('inicio_sabado',Util::HOR_MIN_SEG_VIEW($neg->horario->hor_ini_sab)) }}">
                                    @if ($errors->has('inicio_sabado'))
                                        <span class="invalid-feedback" role="alert"> {{ $errors->first('inicio_sabado') }} </span>
                                    @endif
                                </td>
                                <td>
                                    <input type="text" id="fin_sabado" name="fin_sabado"  class="timepicker form-control form-control-sm {{ $errors->has('fin_sabado') ? 'is-invalid' : '' }}"  value="{{ old('fin_sabado',Util::HOR_MIN_SEG_VIEW($neg->horario->hor_fin_sab)) }}">
                                ...
                                <td class="text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="cerrado_sabado" name="cerrado_sabado" {{(old("cerrado_sabado",$neg->horario->hor_cer_sab) != null)?"checked":""}}>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text"  id="inicio_domingo" name="inicio_domingo" class="timepicker form-control form-control-sm {{ $errors->has('inicio_domingo') ? 'is-invalid' : '' }}"  value="{{ old('inicio_domingo',Util::HOR_MIN_SEG_VIEW($neg->horario->hor_ini_dom)) }}">
                                    @if ($errors->has('inicio_domingo'))
                                        <span class="invalid-feedback" role="alert"> {{ $errors->first('inicio_domingo') }} </span>
                                    @endif
                                </td>
                                <td>
                                    <input type="text" id="fin_domingo" name="fin_domingo"  class="timepicker form-control form-control-sm {{ $errors->has('fin_domingo') ? 'is-invalid' : '' }}"  value="{{ old('fin_domingo',Util::HOR_MIN_SEG_VIEW($neg->horario->hor_fin_dom)) }}">
                                ...
                                <td class="text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="cerrado_domingo" name="cerrado_domingo" {{(old("cerrado_domingo",$neg->horario->hor_cer_sab) != null)?"checked":""}}>
            ...
            <div class="acordion" id="infoformaspago">
                ...
                <div class="collapse show mb-2" data-parent="#infoformaspago" id="infoformaspagoOne">
                    ...
                    <select name="formaspago[]" id="formaspago" multiple class="select2 w-100 {{ $errors->has('formaspago') ? 'is-invalid' : '' }}">
                        <option value="EF" {{($neg->formaspago->fpa_efectivo==1)?"selected":""}}> Efectivo </option>
                        <option value="TJ" {{($neg->formaspago->fpa_tarjetas==1)?"selected":""}}> Tarjetas </option>
                    </select>
                ...
                <div class="collapse show mb-2" data-parent="#infoparqueo" id="infoparqueoOne">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <input type="text" id="cantidadmotos" name="cantidadmotos" placeholder="Cantidad"  class="form-control form-control-sm text-right {{ $errors->has('cantidadmotos') ? 'is-invalid' : '' }}" value="{{ old('cantidadmotos',$neg->parqueos->par_cantidad_motos)}}">
                        ...
                        <div class="col-sm-5">
                            ...
                            <input type="text" id="preciomotos" name="preciomotos" placeholder="Precio" class="form-control form-control-sm  text-right {{ $errors->has('preciomotos') ? 'is-invalid' : '' }}" value="{{ old('preciomotos',$neg->parqueos->par_precio_motos)}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <small class="form-text">Cantidad</small>
                            <input type="text" id="cantidadcarros" name="cantidadcarros" placeholder="Cantidad" class="form-control form-control-sm text-right  {{ $errors->has('cantidadcarros') ? 'is-invalid' : '' }}"  value="{{ old('cantidadcarros',$neg->parqueos->par_cantidad_carros)}}">
                        ...
                        <div class="col-sm-5">
                            <small class="form-text">Precio</small>
                            <input type="text" id="preciocarros" name="preciocarros" placeholder="Precio" class="form-control form-control-sm  text-right {{ $errors->has('preciocarros') ? 'is-invalid' : '' }}" value="{{ old('preciocarros',$neg->parqueos->par_precio_carros)}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <small class="form-text">Cantidad</small>
                            <input type="text" id="cantidaddiscapacitados" name="cantidaddiscapacitados" placeholder="Cantidad" class="form-control form-control-sm text-right   {{ $errors->has('cantidaddiscapacitados') ? 'is-invalid' : '' }}"  value="{{ old('cantidaddiscapacitados',$neg->parqueos->par_cantidad_discapacitados)}}">
                        ...
                        <div class="col-sm-5">
                            <small class="form-text">Precio</small>
                            <input type="text" id="preciodiscapacitados" name="preciodiscapacitados" placeholder="Precio" class="form-control form-control-sm text-right {{ $errors->has('preciodiscapacitados') ? 'is-invalid' : '' }}" value="{{ old('preciodiscapacitados',$neg->parqueos->par_precio_discapacitados)}}">
            ...
            <div class="acordion" id="infocovid19">
                ...
                <div class="collapse show mb-2" data-parent="#infocovid19" id="infocovid19One">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="procedimiento" id="procedimiento" class="form-control {{ $errors->has('procedimiento') ? 'is-invalid' : '' }}">{{ old('procedimiento',$neg->covid19->cov_procedimiento)}}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <button type="submit" class="btn btn-primary btn-block">Editar Negocio</button>
                </div>
            </div>
        </form>
    </div>
